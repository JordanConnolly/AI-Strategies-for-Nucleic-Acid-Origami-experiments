...
for i in range(len(experiment_set_names)):
    ...
    total_df = pd.read_csv(stored_path + "/" + experiment_set + "reverse_non_norm_total_table.csv")
    # result tables
    ...
    total_table.to_csv("Analysis_Output/" + experiment_set.strip("/") + "reverse_non_norm_hypervolume_presentation_table.csv")
