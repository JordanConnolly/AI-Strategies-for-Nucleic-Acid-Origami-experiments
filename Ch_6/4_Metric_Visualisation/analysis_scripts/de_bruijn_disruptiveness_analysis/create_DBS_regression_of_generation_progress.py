...
for origami_name in list_of_origami_names:
    ...
    for experiments in experiment_list:
        ...
        for i in problem_pathway_name:
            ...
            fit_min_floats = pd.DataFrame(create_list_of_floats(fit_max), columns=["M1", "M2", "M3", "M4"])
...
experiment_name_for_plot = plot_name + " Maximum Fitness Metric Average Repetitions " \
...
fig.savefig(path_parent + "/Logbook_Plots/logbook_minimum_fitness_plots/" + save_name +
            "DBS_Initial_Maximum_Fitness_Metric_GA_All_Repetitions_Sweep_Set_1_All_Repetitions" + ".png",
