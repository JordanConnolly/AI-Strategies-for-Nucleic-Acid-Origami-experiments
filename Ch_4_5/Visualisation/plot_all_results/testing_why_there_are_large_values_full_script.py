...
parameters.update({'estimator__n_estimators': [500]})
parameters.update({'estimator__max_depth': [5]})

# Parameter Grid for RFE
parameters.update({"rfe__n_features_to_select": [25]})
